...
ffmpeg -hide_banner -v quiet -stats -y -canvas_size 854x356 -i "%r1%1.mkv" -i "%fi%" -map 0 -map 1 -map -1:v -c:v copy -c:a aac -ac 2 -ab 128k -map_metadata:g -1 -metadata title="[AniDL] Mars Red [WEB 480p 10bit][Soap]" -metadata:s:v title="" -metadata:s:a title="Japanese" "1%r1%.mkv"
ffmpeg -hide_banner -v quiet -stats -y -canvas_size 1280x536 -i "%r2%1.mkv" -i "%fi%" -map 0 -map 1 -map -1:v -c:v copy -c:a aac -ac 2 -ab 128k -map_metadata:g -1 -metadata title="[AniDL] Mars Red [WEB 720p 10bit][Soap]" -metadata:s:v title="" -metadata:s:a title="Japanese" "1%r2%.mkv"
ffmpeg -hide_banner -v quiet -stats -y -canvas_size 1920x804 -i "%r3%1.mkv" -i "%fi%" -map 0 -map 1 -map -1:v -c:v copy -c:a aac -ac 2 -ab 128k -map_metadata:g -1 -metadata title="[AniDL] Mars Red [WEB 1080p 10bit][Soap]" -metadata:s:v title="" -metadata:s:a title="Japanese" "1%r3%.mkv"
