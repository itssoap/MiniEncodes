...
source = "S01E11-Narrow-minded.mkv"
...
cred_op = source[3310:5468] # this is the OP with credits
cred_ed = source[31674:33828] # this is the ED with credits
...
op_fin = atf.ApplyCredits(cred_op, op[:-26], deband[3310:5468])
op_fin = CoolDegrain(op_fin, thsad=16, thsadc=48, blksize=8, overlap=4)

ed_fin = atf.ApplyCredits(cred_ed, ed[:-30], deband[31674:33828])
ed_fin = CoolDegrain(ed_fin, thsad=16, thsadc=48, blksize=8, overlap=4)

mrg = deband[:3310]+op_fin+deband[5468:31674]+ed_fin+deband[33828:]
...
# source.set_output(0)
# src.set_output(1)
#lvf.diff(source, src).set_output(2)
